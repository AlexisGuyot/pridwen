...
object UPrepend {
    ...
    protected def inhabit_Type[L1, L2, Out0 <: HList]: Aux[L1, L2, Out0] = new UPrepend[L1, L2] { type Out = Out0 }
    ...
    private trait UPrepend_RT[L1 <: HList, L2 <: HList] { type Out <: HList }
    private trait LowestPriorityUPrepend_RT {
        type Aux[L1 <: HList, L2 <: HList, Out0 <: HList] = UPrepend_RT[L1, L2] { type Out = Out0 }
        protected def inhabit_Type[L1 <: HList, L2 <: HList, Out0 <: HList]: Aux[L1, L2, Out0] = new UPrepend_RT[L1, L2] { type Out = Out0 }
        ...
        implicit def element_is_not_in_l1 [
            ...
            p: UPrepend_RT.Aux[Out0, T2, Out1]
    ...
    private trait LowPriorityUPrepend_RT extends LowerPriorityUPrepend_RT {
        ...
        implicit def element_is_a_nested_field [
            ...
            p: UPrepend_RT.Aux[Out1, T2, Out2]
