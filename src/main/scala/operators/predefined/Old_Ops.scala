package pridwen.operators.predefined.old
...
object ops {
    def constructGraph[
        ...
        res_model: Graph[(Field[W.`'id`.T, NodeID_Type] :: Source_Att) :: (Field[W.`'id`.T, NodeID_Type] :: Dest_Att) :: (Field[W.`'weight`.T, Int] :: Edge_Att) :: HNil, W.`'id`.T, W.`'id`.T]
